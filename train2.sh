...
python -m torch.distributed.launch --nproc_per_node=3 --master_port=4322 realesrgan/train.py -opt options/finetune_realesrgan_x4plus_yh.yml --launcher pytorch
